...
<div class="message">
Use this page to examine CSS changes have been made, to ensure that nothing has
broken. And the callout box you're looking at right now was produced by wrapping
...
Short bits of code can be rendered as fixed-width by wrapping them in backticks
or `<code>` elements.
